...
// export default function CandleChart({ assetInfo, chartOpt }) {
...
//   useEffect(() => {
//     const socket = new SockJS('http://localhost:8080/ws'); // WebSocket 설정
...
//         // 서버로부터 메시지 구독 및 처리
//         stompClient.current.subscribe('/topic/get_ticker_price', (message) => {
//           try {
